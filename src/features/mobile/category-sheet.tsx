...
import { getPlaceImageUrl, type MobilePlace, type PlaceCategory } from "@/features/mobile/mobile-data";
  ...
  return (
    ...
    >
      <div
        ...
        aria-label={`${areaName} ${category} 목록`}
      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-between gap-3">
          <div>
            ...
            <h2 className="mt-1 text-xl font-extrabold">{category}</h2>
          </div>
          <button
            aria-label="목록 닫기"
